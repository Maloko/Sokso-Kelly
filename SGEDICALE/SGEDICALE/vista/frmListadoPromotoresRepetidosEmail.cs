...
{
    public partial class frmListadoPromotoresRepetidosEmail : DevComponents.DotNetBar.Office2007Form
    {
        public frmListadoPromotoresRepetidosEmail()
        {
            InitializeComponent();
        }

        private void frmListadoPromotoresRepetidosEmail_Load(object sender, EventArgs e)
        {
        ...
        public void cargapromotores()
        {
            ...
            dgvPromotores.DataSource = CPromotor.listadorepetidosxEmail();
        ...
        private void txtnombre_TextChanged(object sender, EventArgs e)
        {
            ...
            if (nombre != "")
            {
                dgvPromotores.DataSource = CPromotor.busquedarepetidosxEmail(nombre);
                lbregistro.Text = dgvPromotores.Rows.Count.ToString() + " registros.";
                dgvPromotores.Refresh();
            }
            else
        ...
        private void frmListadoPromotoresRepetidosEmail_KeyUp(object sender, KeyEventArgs e)
        {
